...
export const accountApi = {
  async orders(params: { search?: string; status?: string; page?: number; per_page?: number } = {}): Promise<AccountOrdersResponse> {
    ...
    return (body.data as AccountOrdersResponse) ?? { data: [], meta: { current_page: 1, last_page: 1, per_page: 10, total: 0, from: null, to: null } };
  },
  ...
  async updateProfile(data: { name: string; first_name?: string | null; last_name?: string | null }): Promise<AccountProfile> {
