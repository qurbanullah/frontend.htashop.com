...
const SECTIONS = [
  ...
  },
  {
    ...
    body:
      "We retain personal information only as long as necessary for the purposes described in this policy and to meet legal obligations:",
    bullets: [
  ...
  },
  {
    ...
    body:
      "To exercise any of the above rights, contact us at privacy@htashop.com. We will verify your identity and respond within the timeframe required by applicable law (generally 30 days). You may also lodge a complaint with your local data protection authority.",
  },
  {
    heading: "11. Children's Privacy",
    body:
      "HTAShop is not directed to children under 16, and we do not knowingly collect personal information from children. If you believe a child has provided us with personal data, contact us and we will delete it promptly.",
  },
  {
    heading: "12. Third-Party Links",
    body:
      "Our platform may contain links to third-party websites. We are not responsible for the privacy practices of those sites, and we encourage you to review their policies before providing any information.",
  },
  {
    heading: "13. Changes to This Policy",
    body:
      "We may update this Privacy Policy from time to time. Material changes will be posted on this page with an updated effective date. For significant changes affecting your rights, we will notify you by email or a prominent notice on the platform.",
  },
  {
    heading: "14. Contact Us",
    body:
      "For questions or concerns about this Privacy Policy or our data practices, contact our Data Protection team:",
    bullets: [
