...
const SECTIONS = [
  {
    ...
    body:
      "This website and the HTAShop platform (the \"Service\") are owned and operated by High Tech Advancement Solutions (Private) Limited, CUIN 0321375 (hereinafter \"HTAShop\", \"we\", \"us\" and \"our\"). Our principal place of business is in Pakistan. We offer this website, including all information, tools, products, and services available from this website, to you, the user, conditioned upon your acceptance of all terms, conditions, policies, and notices stated here.",
    bullets: [
  ...
  },
  {
    ...
    body:
      "All orders are subject to availability and acceptance. A contract for the sale of goods is formed only when we confirm your order. We reserve the right to not process an order that you place on our website, usually for the following reasons:",
    bullets: [
  ...
  },
  {
    ...
    body:
      "Delivery timelines, cancellations, returns, exchanges, and refunds are governed by our Shipping, Cancellations and Return/Refund Policy, which forms part of these Terms. Please review it before making a purchase.",
  },
  {
  ...
  },
  {
    ...
    body:
      "We may immediately change or terminate your access to our products, services, and this website, or any online membership(s) with us, with or without notice, at any time, without liability to you, any other user, or any third party. We reserve the right to terminate your access if, without limitation, you have:",
    bullets: [
  ...
  },
  {
    ...
    body:
      "These Terms are governed by the laws of the Islamic Republic of Pakistan, and you agree that the competent courts of Pakistan (including any consumer court) will have exclusive jurisdiction in any dispute that you have with us.",
  },
  {
    heading: "14. Contact",
    body:
      "Questions about these Terms? Contact us at support@htashop.com or +92 300 0000000, or write to High Tech Advancement Solutions (Private) Limited, Pakistan — CUIN 0321375.",
  },
];
