...
const SECTIONS = [
  {
    ...
    body:
      "Cookies are small text files stored on your device (computer, tablet, or phone) when you visit a website. They allow the website to recognise your device, remember your preferences, and understand how you use the site. Similar technologies — such as local storage, pixels, and web beacons — are used for the same purposes and are covered by this policy.",
  },
  {
  ...
  },
  {
    ...
    body:
      "You can control cookies through your browser settings. Most browsers let you view, block, or delete cookies, and choose whether to accept them site by site:",
    bullets: [
  ...
  },
  {
    ...
    body:
      "Strictly necessary cookies do not require consent because they are essential to provide the service you request. Analytics and marketing cookies are placed with your consent where required by applicable law (such as the GDPR or the UK PECR). You can change your preferences at any time through your browser settings or our consent prompt.",
  },
  {
    heading: "7. Updates to This Policy",
    body:
      "We may update this Cookies Policy as our services and the technologies we use evolve. Any changes will be posted on this page with an updated effective date.",
  },
  {
    heading: "8. Contact",
    body:
      "If you have questions about our use of cookies, contact us at privacy@htashop.com or support@htashop.com.",
  },
];
