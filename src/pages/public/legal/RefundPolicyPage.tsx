...
const SECTIONS = [
  {
    heading: "1. Overview",
    body:
      "This Shipping, Cancellations and Return/Refund Policy explains how we deliver orders and how complaints, cancellations, returns, exchanges, and refunds are handled. It forms part of our Terms of Use. By placing an order on HTAShop, you agree to the terms of this policy.",
  },
  {
  ...
  },
  {
    ...
    body:
      "For any complaint or query relating to our website, products, or service, contact us at support@htashop.com or +92 300 0000000. We will use our best endeavours to respond to your complaint or query within 2 business days of receipt.",
    bullets: [
  ...
  },
  {
    ...
    body:
      "You may cancel any order within 24 hours of placement. After this period, no cancellation requests shall be entertained, except where required by applicable consumer law. You can request a cancellation from your order history or by contacting support@htashop.com.",
  },
  {
    heading: "6. Returns, Exchanges and Refunds — Eligibility",
    body:
      "We operate a no return, exchange, and no refund policy except where the goods you receive are different from what you ordered on our website, or are defective or damaged.",
    bullets: [
  ...
  },
  {
    ...
    body:
      "Instead of a refund, we may provide you with store credit so that you can exchange the returned goods for any other item of the same value from our website. Store credit is issued to your HTAShop account and can be applied at checkout.",
  },
  {
  ...
  },
  {
    ...
    body:
      "If you have not received your refund within the stated timeframe, first check with your bank or payment provider. If the refund is still missing, contact us at support@htashop.com with your order number and we will investigate promptly.",
  },
  {
    heading: "11. Policy Changes",
    body:
      "We may update this policy from time to time. Changes will be posted on this page with an updated effective date and apply to orders placed after the change, unless required by law to apply earlier.",
  },
  {
    heading: "12. Contact",
    body:
      "For shipping, cancellation, return, or refund support, contact us at support@htashop.com or +92 300 0000000.",
  },
];
