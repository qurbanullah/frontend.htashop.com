...
export default function CheckoutPage() {
  ...
  // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: checkout flow — multi-section order placement with address handling and validation; guard clauses are deliberately sequential
      ...
      <div className="mt-6 grid gap-8 lg:grid-cols-12">
        ...
        <div className="lg:col-span-4">
          <div className="rounded-2xl border border-gray-200 p-5 dark:border-gray-800">
            ...
            {error && (
              <div className="mt-3 rounded-lg border border-red-200 bg-red-50 p-3 text-red-700 text-sm dark:border-red-900/50 dark:bg-red-900/20 dark:text-red-300">
                {error}
              </div>
            )}
            ...
            <button
              ...
              className="mt-5 flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-blue-600 font-semibold text-sm text-white transition-colors hover:bg-blue-700 disabled:opacity-60"
            >
              {placing ? (
