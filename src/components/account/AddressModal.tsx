...
export function AddressModal({ isOpen, onClose, address, onSaved }: Props) {
  ...
  const field = (labelText: string, key: keyof FormState, type = "text", placeholder = "") => (
    <div className="space-y-1.5">
      <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">{labelText}</Label>
      <Input
        type={type}
  ...
  return (
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          {field("Address line 2 (optional)", "address_line_2", "text", "Apartment, suite, unit, building")}
        </div>
