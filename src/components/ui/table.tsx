...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      'border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      'border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 font-medium',
      className
    )}
    {...props}
  />
