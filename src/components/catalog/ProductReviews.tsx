      ...
      <div className="mt-5 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-gray-200 p-5 dark:border-gray-800">
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-gray-500 text-sm dark:text-gray-400">/ 5</span>
          </div>
          <div className="mt-2">
...
function ReviewCard({
  ...
  return (
    <div className="rounded-2xl border border-gray-200 p-4 dark:border-gray-800">
      ...
      <p className="mt-2 text-gray-600 text-sm dark:text-gray-300">{review.body}</p>
      ...
      <div className="mt-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            onClick={() => onVote(true)}
            disabled={voting}
            className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-gray-500 text-xs hover:bg-gray-100 disabled:opacity-60 dark:text-gray-400 dark:hover:bg-gray-800"
          >
